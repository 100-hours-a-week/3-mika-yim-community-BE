...
public class TermService {
    ...
    public TermService() {
        String termsOfUseContent = """
                '아무말대잔치' 이용약관
                제1조 (목적) 이 약관은 '아무말대잔치'(이하 '커뮤니티')에서 제공하는 서비스의 이용과 관련하여 커뮤니티와 회원 간의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.
        ...
        String privacyPolicyContent = """
                개인정보 처리방침
                '아무말대잔치'는 이용자의 개인정보를 중요시하며, 「개인정보 보호법」을 준수하고 있습니다. 본 개인정보 처리방침을 통해 이용자가 제공하는 개인정보가 어떠한 용도와 방식으로 이용되고 있으며, 개인정보보호를 위해 어떠한 조치가 취해지고 있는지 알려드립니다.
        ...
        String marketingOptInContent = """
                마케팅 정보 수신 동의 (선택)
                제1조 (수집 및 이용 목적) '아무말대잔치'는 회원의 동의를 받아 아래와 같은 목적을 위해 마케팅 정보를 발송합니다.
                ...
                제4조 (동의 거부에 관한 안내) 귀하는 본 마케팅 정보 수신에 동의하지 않을 권리가 있으며, 동의하지 않으셔도 '아무말대잔치'의 모든 서비스를 정상적으로 이용하실 수 있습니다.
